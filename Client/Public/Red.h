...
protected:
	explicit CRed(ID3D11Device* pDevice, ID3D11DeviceContext* pDevice_Context);
	explicit CRed(const CRed& rhs);
	virtual ~CRed() = default;
...
public:
	static CRed* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, const CTransform::TRANSFORMDESC& TransformDesc);
