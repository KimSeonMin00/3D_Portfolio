...
{
public:
	enum STATE { STATE_INIT, STATE_IDLE, STATE_MOVE, STATE_ATTACK, STATE_Q, STATE_Q_CHARGE, STATE_W, STATE_E, STATE_R, STATE_KNOCKBACK, STATE_DEATH, STATE_END };
