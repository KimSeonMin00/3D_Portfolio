...
protected:
	explicit CRazorBeak(ID3D11Device* pDevice, ID3D11DeviceContext* pDevice_Context);
	explicit CRazorBeak(const CRazorBeak& rhs);
	virtual ~CRazorBeak() = default;
...
public:
	static CRazorBeak* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, const CTransform::TRANSFORMDESC& TransformDesc);
