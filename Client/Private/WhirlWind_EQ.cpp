...
HRESULT CWhirlWind_EQ::SetUp_Components()
{
	...
	/* For.Com_Model*/
	if (FAILED(__super::Add_Components(m_iLevel, TEXT("Prototype_Component_Model_E_Q_Slash"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
		return E_FAIL;

	if (FAILED(__super::Add_Components(m_iLevel, TEXT("Prototype_Component_Model_Tornado_2"), TEXT("Com_Model_Wind"), (CComponent**)&m_pModel_InnerWind)))
		return E_FAIL;

	if (FAILED(__super::Add_Components(m_iLevel, TEXT("Prototype_Component_Texture_E_Q_Black"), TEXT("Com_Texture_Black"), (CComponent**)&m_pTextureAlpha)))
		return E_FAIL;

	if (FAILED(__super::Add_Components(m_iLevel, TEXT("Prototype_Component_Texture_E_Q_White"), TEXT("Com_Texture_White"), (CComponent**)&m_pTexture_White)))
		return E_FAIL;

	if (FAILED(__super::Add_Components(m_iLevel, TEXT("Prototype_Component_Texture_Tornado_Alpha"), TEXT("Com_Texture_Wind"), (CComponent**)&m_pTexture_InnerWind)))
		return E_FAIL;
